...
**GitHub Repository:** https://github.com/karthick5973/enable-dataset-restoration-after-rebuild-and-provide-personal-use-code-documenta

**Access the application:** Clone and run locally or deploy to Internet Computer
...
4. **Deploy the backend canister locally:**
   ```bash
   dfx deploy backend
   ```
...
### Deploy Frontend to GitHub Pages (Recommended)
...
2. **Enable GitHub Pages:**
   ...
   - Your app will be available at `https://github.com/karthick5973/enable-dataset-restoration-after-rebuild-and-provide-personal-use-code-documenta`

3. **Alternative: Use GitHub Actions for CI/CD**
   - Automated builds and deployments on every push
...
- **Maintain the repository** for permanent access
...
- **URL Pattern:** `http://localhost:3000`
- **Purpose:** Testing and development
- **Data Availability:** Backend runs locally
- **Impact:** Data persists as long as local backend is running

### GitHub Repository (Source Code)

- **URL Pattern:** `https://github.com/karthick5973/enable-dataset-restoration-after-rebuild-and-provide-personal-use-code-documenta`
- **Purpose:** Version control and permanent storage
- **Data Availability:** Source code accessible 24/7
- **Impact:** Production-ready deployment

### Production Deployment

- **Recommended:** Deploy to Internet Computer mainnet for backend
- **Frontend:** Use GitHub Pages or any static hosting
- **Data Availability:** Live apps stay online continuously
- **Impact:** Data persists according to the 7-day retention policy
...
- Verify Node.js version is v18 or higher: `node --version`
- Clear node_modules and reinstall: `rm -rf node_modules && pnpm install`
- Check DFX is properly installed: `dfx --version`

---

## Support & Contributing

**Repository:** https://github.com/karthick5973/enable-dataset-restoration-after-rebuild-and-provide-personal-use-code-documenta
...
**Built with ❤️ for Personal Spare Parts Management